...
```
cd existing_repo
git remote add origin https://gitlab-student.centralesupelec.fr/massine.el-khader/spoofing-detection.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-student.centralesupelec.fr/massine.el-khader/spoofing-detection/-/settings/integrations)
